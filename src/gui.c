...
static void clip_gui_remove_signal_data(GtkWidget* widget, gpointer data)
{
    g_free(data);
}

static void clip_gui_history_selected(GtkWidget* widget, gpointer data)
{
...
static void clip_gui_add_menu_item(char* text)
{
    ...
    g_signal_connect((GObject*)item, "activate", (GCallback)clip_gui_history_selected, copy);
    g_signal_connect((GObject*)item, "destroy", (GCallback)clip_gui_remove_signal_data, copy);
